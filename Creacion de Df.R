...
# Crear el gr·fico de lÌneas con ggplot
...
ggplot(gold, aes(x = Date)) +
  ...
  theme(panel.background = element_rect(fill = "black"),  # Modifica el fondo del panel  #8B8B83
        ...
        axis.line = element_line(color = "white"),  # Modifica el color de las lÌneas de los ejes a blanco
        panel.grid = element_blank(),
        plot.title = element_text(hjust = 0.5, color = "white", face = "bold"))+  # Ajustes del tÌtulo
...
ggplot(gold, aes(x = Date)) +
  ...
  theme(panel.background = element_rect(fill = "black"),  # Modifica el fondo del panel  #8B8B83
        ...
        axis.line = element_line(color = "goldenrod"),  # Modifica el color de las lÌneas de los ejes a blanco
        panel.grid = element_blank(),
        plot.title = element_text(hjust = 0.5, color = "goldenrod", face = "bold"))+  # Ajustes del tÌtulo
  guides(color = guide_legend(title = NULL))
...
ggplot(gold, aes(x = Date)) +
  ...
  scale_y_continuous(breaks = seq(0, max(gold$Future), by = 100)) +
  theme(panel.background = element_rect(fill = "black"),  # Modifica el fondo del panel  #8B8B83
        panel.grid.major.x = element_blank(),  # Elimina las lÌneas verticales principales
        panel.grid.minor.x = element_blank(),  # Elimina las lÌneas verticales secundarias (si las hubiera)
        plot.background = element_rect(fill = "black"),   # Modifica el fondo del plot
        legend.background = element_rect(fill = "black", color = "white"),  # Modifica el fondo de la leyenda
        legend.text = element_text(color = "white"),  # Modifica el color del texto de la leyenda a blanco
        axis.text = element_text(color = "white"),  # Modifica el color de los valores de los ejes a blanco
...
ggplot(gold, aes(x = Date)) +
  ...
  theme(plot.background = element_rect(fill = "white"),   # Modifica el fondo del plot
        ...
        axis.line = element_line(color = "black"),  # Modifica el color de las lÌneas de los ejes a blanco
        plot.title = element_text(hjust = 0.5, color = "black", face = "bold"))+  # Ajustes del tÌtulo
  guides(color = guide_legend(title = NULL))
